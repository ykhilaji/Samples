...
/**
  ...
  * version: 25.131-b11
  */
object Json4sMeasurement extends Bench.LocalTime {
  // 100k instead of 1kk
  ...
  performance of "json4s" in {
    // Parameters(records -> 100000): 98.426706 ms
    ...
    // Parameters(records -> 100000): 916.854142 ms
    ...
    // Parameters(records -> 100000): 1591.975848 ms
    ...
    // Parameters(records -> 100000): 1897.512503 ms
